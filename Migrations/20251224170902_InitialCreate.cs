    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "orientation", "Company intro", 1, "🎯", true, "general", "Welcome to Founder's Desk", "https://example.com/video1.mp4" },
                    { 2, "orientation", "Rules & guidelines", 2, "📚", true, "general", "Company Policies", "https://example.com/video2.mp4" },
                    { 3, "orientation", "Working together", 3, "🤝", true, "general", "Team Collaboration", "https://example.com/video3.mp4" },
